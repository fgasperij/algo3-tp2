...
Dados un conjunto de vuelos $C$ y las ciudades $inicio$ y $destino$ podemos definir el conjunto de vuelod $validos$ como:
\begin{align*}
...
Para cada $N$: nº de vuelos se generan $k'$ instancias, con $k' = 3$.

Se llamó al algoritmo $k$ veces, con $k=20$, y de esas corridas se eligió el de menor tiempo de ejecución.

Se sumó el tiempo de las $k'$ corridas.
